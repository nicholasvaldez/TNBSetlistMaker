...
export const BUCKETS: Bucket[] = [
  { id: "must", label: "Must play", short: "Must", verb: "Must play", accent: "#7e9a6a", glyph: "\u2736", hotkey: "1" },
...
export const BUCKET_BY_ID = Object.fromEntries(BUCKETS.map((b) => [b.id, b])) as Record<NonNullable<SongRating>, Bucket>;
